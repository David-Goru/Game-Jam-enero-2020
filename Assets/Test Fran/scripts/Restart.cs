...
public class Restart : MonoBehaviour
{
    ...
    void lose()
    {
        if (playerStats.HP <= 0)
        {
            ...
            GameObject.Find("UI").transform.Find("Upgrade damage").Find("Points").GetComponent<Text>().text = string.Format("({0})", playerStats.LevelDamage);
            GameObject.Find("UI").transform.Find("Upgrade armor").Find("Points").GetComponent<Text>().text = string.Format("({0})", playerStats.LevelArmor);
            GameObject.Find("UI").transform.Find("Upgrade HP").Find("Points").GetComponent<Text>().text = string.Format("({0})", playerStats.LevelHP);
